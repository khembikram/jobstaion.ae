		...
		if ( ! empty( $tabs ) ) : ?>
			<div class="woocommerce-tabs wc-tabs-wrapper">
				...
				<?php foreach ( $tabs as $key => $tab ) : ?>
					<article class="ct-accordion-tab">
						<button
						...
						<div id="tab-<?php echo esc_attr( $key ); ?>" class="entry-content" aria-hidden="<?php echo $is_open && !$index ? "false" : "true" ?>" data-behaviour="drop-down">
